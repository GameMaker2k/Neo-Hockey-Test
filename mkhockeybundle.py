...
pylist = ['CPython', 'IronPython', 'PyPy', 'CPython2', 'CPython3', 'Python2',
          'Python3', 'Python', 'PyPy2', 'PyPy3', 'IronPython2', 'IronPython3']
...
if (len(sys.argv) > 2):
    ...
    outfilebin = os.path.splitext(infile)[0]
    outfilezip = outfilebin + ".zip"
if (os.path.exists(tempdir + "/pybundle")
        and os.path.isfile(tempdir + "/pybundle")):
    os.unlink(tempdir + "/pybundle")
if (os.path.exists(tempdir + "/pybundle")
        and os.path.isdir(tempdir + "/pybundle")):
    shutil.rmtree(tempdir + "/pybundle")
os.mkdir(tempdir + "/pybundle")
if (os.path.exists(tempdir + "/pybundle/__main__.py")
        and os.path.isfile(tempdir + "/pybundle/__main__.py")):
    os.unlink(tempdir + "/pybundle/__main__.py")
if (os.path.exists(tempdir + "/pybundle/__main__.py")
        and os.path.isdir(tempdir + "/pybundle/__main__.py")):
    shutil.rmtree(tempdir + "/pybundle/__main__.py")
shutil.copy2("./" + infile, tempdir + "/pybundle/__main__.py")
if (os.path.exists(tempdir + "/pybundle/libhockeydata")
        and os.path.isfile(tempdir + "/pybundle/libhockeydata")):
    os.unlink(tempdir + "/pybundle/libhockeydata")
if (os.path.exists(tempdir + "/pybundle/libhockeydata")
        and os.path.isdir(tempdir + "/pybundle/libhockeydata")):
    shutil.rmtree(tempdir + "/pybundle/libhockeydata")
shutil.copytree("./libhockeydata", tempdir + "/pybundle/libhockeydata")
if (os.path.exists(tempdir + "/" + outfilezip)
        and os.path.isfile(tempdir + "/" + outfilezip)):
    os.unlink(tempdir + "/" + outfilezip)
if (os.path.exists(tempdir + "/" + outfilezip)
        and os.path.isdir(tempdir + "/" + outfilezip)):
    shutil.rmtree(tempdir + "/" + outfilezip)
shutil.make_archive(tempdir + "/" + outfilebin, "zip", tempdir + "/pybundle")
if (os.path.exists(tempdir + "/pybundle/" + outfilezip)
        and os.path.isfile(tempdir + "/pybundle/" + outfilezip)):
    os.unlink(tempdir + "/pybundle/" + outfilezip)
if (os.path.exists(tempdir + "/pybundle/" + outfilezip)
        and os.path.isdir(tempdir + "/pybundle/" + outfilezip)):
    shutil.rmtree(tempdir + "/pybundle/" + outfilezip)
shutil.move(tempdir + "/" + outfilezip, tempdir + "/pybundle/" + outfilezip)
if (os.path.exists(tempdir + "/pybundle/" + outfilebin)
        and os.path.isfile(tempdir + "/pybundle/" + outfilebin)):
    os.unlink(tempdir + "/pybundle/" + outfilebin)
if (os.path.exists(tempdir + "/pybundle/" + outfilebin)
        and os.path.isdir(tempdir + "/pybundle/" + outfilebin)):
...
shutil.move(tempdir + "/pybundle/" + outfilebin,
            "./bundle/" + pystring + "/" + outfilebin)
...
if (os.path.exists(scrfile) and os.path.isfile(
        scrfile) and infile == "mkhockeydata.py"):
