...
pkggiturl = "https://github.com/GameMaker2k/Neo-Hockey-Test.git"
pkghomepage = setuppy_url
pkgsection = "python"
pkgpriority = "optional"
if (sys.version[0] == "2"):
    pkgbuilddepends = "'python2' 'python2-apsw'"
if (sys.version[0] == "3"):
    pkgbuilddepends = "'python' 'python-apsw'"
pkgstandardsversion = "3.9.8"
if (sys.version[0] == "2"):
    pkgpackage = "python2-pyhockeystats"
    pkgoldname = "python2-hockeystats"
if (sys.version[0] == "3"):
