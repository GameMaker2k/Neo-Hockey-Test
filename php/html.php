...
/*
    ...
    $FileInfo: html.php - Last Update: 1/29/2018 Ver. 0.0.1 RC 1 - Author: cooldude2k $
*/
...
while ($lrow = $lresults->fetchArray()) {
 echo "   <tr>\n    <td style=\"width: 11%; text-align: center;\"><a href=\"".$fileurl."?calendar&amp;league=".urlencode($lrow[0])."\">".htmlspecialchars($lrow[0], ENT_COMPAT | ENT_HTML5, "UTF-8")."</a></td>\n    <td style=\"width: 23%;\"><a href=\"".$fileurl."?calendar&amp;league=".urlencode($lrow[0])."\">".htmlspecialchars($lrow[1], ENT_COMPAT | ENT_HTML5, "UTF-8")."</a></td>\n    <td style=\"width: 10%; text-align: center;\">".$lrow[2]."</td>\n    <td style=\"width: 23%;\">".$lrow[3]."</td>\n    <td style=\"width: 10%; text-align: center;\">".$lrow[4]."</td>\n    <td style=\"width: 11%; text-align: center;\">".$lrow[5]."</td>\n    <td style=\"width: 10%; text-align: center;\">".$lrow[6]."</td>\n   </tr>\n"; }
echo "  </table>\n";
?>
 </body>
</html>
