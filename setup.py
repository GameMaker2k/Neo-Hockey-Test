...
'''
    ...
    $FileInfo: setup.py - Last Update: 12/03/2023 Ver. 0.8.8 RC 1 - Author: cooldude2k $
'''
...
if (os.path.exists("." + os.sep + "scripts" + pyver)
        and os.path.isdir("." + os.sep + "scripts" + pyver)):
    shutil.rmtree("." + os.sep + "scripts" + pyver)
    print("removed directory '." + os.sep + "scripts" + pyver + "'")
if (os.path.exists("." + os.sep + "scripts" + pyver)
        and os.path.isfile("." + os.sep + "scripts" + pyver)):
...
getsymlist = [
    ...
    "mkhockeyxmlfromolddatabase" + pyver,
    "mkhockeyxmlfromsql" + pyver,
    "mkhockeydatabase" + pyver,
    "mkhockeydatabasefromsql" + pyver,
    "mkhockeypyfromdatabase" + pyver,
    "mkhockeypyfromxmlfile" + pyver,
    "mkhockeypyaltfromdatabase" + pyver,
    "mkhockeypyaltfromxmlfile" + pyver,
    "mkhockeysqlfromdatabase" + pyver,
    "mkhockeysqlfromxmlfile" + pyver,
    "mkhockeyjsonfromxml" + pyver,
    "mkhockeyxmlfromjson" + pyver,
    "mkhockeyxmlfileclean" + pyver]
getscrlist = [
    'scripts' + pyver + os.sep + 'mkhockeytool' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeydata' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeydatabase' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeydatabasefromsql' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeypyfromdatabase' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeypyfromxmlfile' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeysqlfromdatabase' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeysqlfromxmlfile' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeyxmlfile' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeyxmlfileclean' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeyxmlfromolddatabase' + pyver + '.py',
    'scripts' + pyver + os.sep + 'mkhockeyxmlfromsql' + pyver + '.py']
if (symlinkenable):
    getsymlist = [
        "mkhockeyxmlfile",
        ...
        "mkhockeyxmlfileclean" + pyver]
    getscrlist = [
        'scripts' + pyver + os.sep + 'mkhockeytool.py',
        'scripts' + pyver + os.sep + 'mkhockeydata.py',
        'scripts' + pyver + os.sep + 'mkhockeydatabase.py',
        'scripts' + pyver + os.sep + 'mkhockeydatabasefromsql.py',
        'scripts' + pyver + os.sep + 'mkhockeypyfromdatabase.py',
        'scripts' + pyver + os.sep + 'mkhockeypyfromxmlfile.py',
        'scripts' + pyver + os.sep + 'mkhockeysqlfromdatabase.py',
        'scripts' + pyver + os.sep + 'mkhockeysqlfromxmlfile.py',
        'scripts' + pyver + os.sep + 'mkhockeyxmlfile.py',
        'scripts' + pyver + os.sep + 'mkhockeyxmlfileclean.py',
        'scripts' + pyver + os.sep + 'mkhockeyxmlfromolddatabase.py',
        'scripts' + pyver + os.sep + 'mkhockeyxmlfromsql.py',
        'scripts' + pyver + os.sep + 'mkhockeytool' + pyver + '.py',
        'scripts' + pyver + os.sep + 'mkhockeydata' + pyver + '.py',
        'scripts' + pyver + os.sep + 'mkhockeydatabase' + pyver + '.py',
        'scripts' + pyver + os.sep + 'mkhockeydatabasefromsql' + pyver + '.py',
