...
'''
    ...
    $FileInfo: hockeydatabase.py - Last Update: 11/26/2023 Ver. 0.7.6 RC 1 - Author: cooldude2k $
'''
...
def MakeHockeyGame(sqldatacon, leaguename, date, time, hometeam, awayteam, periodsscore, shotsongoal, ppgoals, shgoals, periodpens, periodpims, periodhits, takeaways, faceoffwins, atarena, isplayoffgame):
 ...
 hometeamupdatedict.update( { 'Wins': int(hometeaminfo[38]), 'TWins': int(hometeaminfo[39]), 'Points': int(hometeaminfo[40]) } );
 awayteamupdatedict.update( { 'Wins': int(awayteaminfo[38]), 'TWins': int(awayteaminfo[39]), 'Points': int(awayteaminfo[40]) } );
 hometeamupdatedict.update( { 'Losses': int(hometeaminfo[41]), 'TLosses': int(hometeaminfo[42]), 'Points': int(hometeaminfo[40]) } );
 awayteamupdatedict.update( { 'Losses': int(awayteaminfo[37]), 'TLosses': int(awayteaminfo[37]), 'Points': int(awayteaminfo[40]) } );
 ...
 hometeamupdatedict.update( { 'OTSOWins': int(hometeaminfo[44]), 'TWins': int(hometeaminfo[39]), 'Points': int(hometeaminfo[40]) } );
 awayteamupdatedict.update( { 'OTSOWins': int(awayteaminfo[44]), 'TWins': int(awayteaminfo[39]), 'Points': int(awayteaminfo[40]) } );
 hometeamupdatedict.update( { 'OTLosses': int(hometeaminfo[43]) } );
 awayteamupdatedict.update( { 'OTLosses': int(awayteaminfo[43]) } );
 hometeamupdatedict.update( { 'OTSOLosses': int(hometeaminfo[44]), 'TLosses': int(hometeaminfo[39]), 'Points': int(hometeaminfo[40]) } );
 awayteamupdatedict.update( { 'OTSOLosses': int(awayteaminfo[44]), 'TLosses': int(awayteaminfo[39]), 'Points': int(awayteaminfo[40]) } );
