...
hockeyarray = libhockeydata.AddHockeyLeagueToArray(hockeyarray, "NHL", "National Hockey League", "USA", "United States", "20210113", "Division=3,Conference=2", "ORDER BY Points DESC, GamesPlayed ASC, TWins DESC, Losses ASC, GoalsDifference DESC", True, True);
hockeyarray = libhockeydata.AddHockeyConferenceToArray(hockeyarray, "NHL", "Eastern");
hockeyarray = libhockeydata.AddHockeyDivisionToArray(hockeyarray, "NHL", "North", "Eastern", "Scotia", "Division");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Calgary", "AB", "CAN", "Canada", "Alberta", "Flames", "Eastern", "North", "Scotiabank Saddledome", "Calgary", "", "AHL:Stockton Heat");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Edmonton", "AB", "CAN", "Canada", "Alberta", "Oilers", "Eastern", "North", "Rogers Place", "Edmonton", "", "AHL:Bakersfield Condors");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Montreal", "QC", "CAN", "Canada", "Quebec", "Canadiens", "Eastern", "North", "Bell Centre", "Montreal", "", "AHL:Laval Rocket");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Ottawa", "ON", "CAN", "Canada", "Ontario", "Senators", "Eastern", "North", "Canadian Tire Centre", "Ottawa", "", "AHL:Belleville Senators");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Toronto", "ON", "CAN", "Canada", "Ontario", "Maple Leafs", "Eastern", "North", "Scotiabank Arena", "Toronto", "", "AHL:Toronto Marlies");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Vancouver", "BC", "CAN", "Canada", "British Columbia", "Canucks", "Eastern", "North", "Rogers Arena", "Vancouver", "", "AHL:Utica Comets");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Winnipeg", "MB", "CAN", "Canada", "Manitoba", "Jets", "Eastern", "North", "Bell MTS Place", "Winnipeg", "", "AHL:Manitoba Moose");
hockeyarray = libhockeydata.AddHockeyDivisionToArray(hockeyarray, "NHL", "East", "Eastern", "Massmutual", "Division");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Boston", "MA", "USA", "United States", "Massachusetts", "Bruins", "Eastern", "East", "TD Garden", "Boston", "", "AHL:Providence Bruins");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Buffalo", "NY", "USA", "United States", "New York", "Sabres", "Eastern", "East", "KeyBank Center", "Buffalo", "", "AHL:Rochester Americans");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "New Jersey", "NJ", "USA", "United States", "New Jersey", "Devils", "Eastern", "East", "Prudential Center", "New Jersey", "", "AHL:Binghamton Devils");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Uniondale", "NY", "USA", "United States", "New York", "Islanders", "Eastern", "East", "Nassau Coliseum", "New York", "", "AHL:Bridgeport Sound Tigers");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "New York City", "NY", "USA", "United States", "New York", "Rangers", "Eastern", "East", "Madison Square Garden", "New York", "", "AHL:Hartford Wolf Pack");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Philadelphia", "PA", "USA", "United States", "Pennsylvania", "Flyers", "Eastern", "East", "Wells Fargo Center", "Philadelphia", "", "AHL:Lehigh Valley Phantoms");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Pittsburgh", "PA", "USA", "United States", "Pennsylvania", "Penguins", "Eastern", "East", "PPG Paints Arena", "Pittsburgh", "", "AHL:Wilkes-Barre/Scranton Penguins");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Washington", "DC", "USA", "United States", "District of Columbia", "Capitals", "Eastern", "East", "Capital One Arena", "Washington", "", "AHL:Hershey Bears");
hockeyarray = libhockeydata.AddHockeyConferenceToArray(hockeyarray, "NHL", "Western");
hockeyarray = libhockeydata.AddHockeyDivisionToArray(hockeyarray, "NHL", "Central", "Western", "Discover", "Division");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Carolina", "NC", "USA", "United States", "North Carolina", "Hurricanes", "Western", "Central", "PNC Arena", "Carolina", "", "AHL:Chicago Wolves");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Chicago", "IL", "USA", "United States", "Illinois", "Blackhawks", "Western", "Central", "United Center", "Chicago", "", "AHL:Rockford IceHogs");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Columbus", "OH", "USA", "United States", "Ohio", "Blue Jackets", "Western", "Central", "Nationwide Arena", "Columbus", "", "AHL:Cleveland Monsters");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Dallas", "TX", "USA", "United States", "Texas", "Stars", "Western", "Central", "American Airlines Center", "Dallas", "", "AHL:Texas Stars");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Detroit", "MI", "USA", "United States", "Michigan", "Red Wings", "Western", "Central", "Little Caesars Arena", "Detroit", "", "AHL:Grand Rapids Griffins");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Sunrise", "FL", "USA", "United States", "Florida", "Panthers", "Western", "Central", "BB&T Center", "Florida", "", "AHL:Syracuse Crunch");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Nashville", "TN", "USA", "United States", "Tennessee", "Predators", "Western", "Central", "Bridgestone Arena", "Nashville", "", "AHL:Chicago Wolves");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Tampa Bay", "FL", "USA", "United States", "Florida", "Lightning", "Western", "Central", "Amalie Arena", "Tampa Bay", "", "AHL:Syracuse Crunch");
hockeyarray = libhockeydata.AddHockeyDivisionToArray(hockeyarray, "NHL", "West", "Western", "Honda", "Division");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Anaheim", "CA", "USA", "United States", "California", "Ducks", "Western", "West", "Honda Center", "Anaheim", "", "AHL:San Diego Gulls");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Glendale", "AZ", "USA", "United States", "Arizona", "Coyotes", "Western", "West", "Gila River Arena", "Arizona", "", "AHL:Tucson Roadrunners");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Denver", "CO", "USA", "United States", "Colorado", "Avalanche", "Western", "West", "Ball Arena", "Colorado", "", "AHL:Colorado Eagles");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Los Angeles", "CA", "USA", "United States", "California", "Kings", "Western", "West", "Staples Center", "Los Angeles", "", "AHL:Ontario Reign");
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "St. Paul", "MN", "USA", "United States", "Minnesota", "Wild", "Western", "West", "Xcel Energy Center", "Minnesota", "", "AHL:Iowa Wild");
