...
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "NHL", "Glendale", "AZ", "USA", "United States", "Arizona", "Coyotes", "Western", "Central", "Gila River Arena", "Arizona", "", "");
...
hockeyarray = libhockeydata.AddHockeyLeagueToArray(hockeyarray, "AHL", "American Hockey League", "USA", "United States", "20211015", "Division=4", "ORDER BY PCT DESC, GamesPlayed ASC, TWins DESC, Losses ASC, GoalsDifference DESC", True, True);
...
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "AHL", "Bridgeport", "CT", "USA", "United States", "Connecticut", "Islanders", "Eastern", "Atlantic", "Webster Bank Arena", "Bridgeport", "", "");
...
hockeyarray = libhockeydata.AddHockeyLeagueToArray(hockeyarray, "ECHL", "ECHL", "USA", "United States", "20211021", "Division=4", "ORDER BY Points DESC, GamesPlayed ASC, TWins DESC, Losses ASC, GoalsDifference DESC", True, True);
...
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "ECHL", "St. John's", "NL", "CAN", "Canada", "Newfoundland and Labrador", "Growlers", "Eastern", "North", "Mile One Centre", "Newfoundland", "", "");
...
hockeyarray = libhockeydata.AddHockeyTeamToArray(hockeyarray, "ECHL", "Trois-Rivières", "QC", "CAN", "Canada", "Quebec", "Lions", "Eastern", "North", "Le Nouveau Colisée", "Trois-Rivières", "", "");
