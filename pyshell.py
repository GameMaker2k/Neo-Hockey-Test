...
'''
    ...
    $FileInfo: pyshell.py - Last Update: 11/30/2023 Ver. 0.8.0 RC 1 - Author: cooldude2k $
'''

from __future__ import division, absolute_import, print_function;
import sys, os, traceback, code, re, readline, libhockeydata;
...
if(len(sys.argv)<2):
 ...
 cmdinput=None;
 print("PyShell "+sys.version+" on "+sys.platform+os.linesep+"Loaded Python module "+libhockeydata.__program_name__+" "+libhockeydata.__version__+os.linesep);
 while(True):
  try:
