...
libhockeydata.MakeHockeyConferences(sqldatacon, "FHL", "", True);
libhockeydata.MakeHockeyDivisions(sqldatacon, "FHL", "", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Winston-Salem", "NC", "USA", "United States", "North Carolina", "Thunderbirds", "", "", "Winston-Salem Fairgrounds Annex", "Carolina", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Cornwall", "ON", "CAN", "Canada", "Ontario", "Nationals", "", "", "Ed Lumley Arena", "Cornwall", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Danville", "IL", "USA", "United States", "Illinois", "Dashers", "", "", "David S. Palmer Arena", "Danville", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Kingsville", "ON", "CAN", "Canada", "Ontario", "Knights", "", "", "Kingsville Arena Complex", "North Shore", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Port Huron", "MI", "USA", "United States", "Michigan", "Prowlers", "", "", "McMorran Place", "Port Huron", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "FHL", 20171001, "Watertown", "NY", "USA", "United States", "New York", "Wolves", "", "", "Watertown Municipal Arena", "Watertown", "", True, True);
...
libhockeydata.MakeHockeyConferences(sqldatacon, "SPHL", "", True);
libhockeydata.MakeHockeyDivisions(sqldatacon, "SPHL", "", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Pelham", "AL", "USA", "United States", "Alabama", "Bulls", "", "", "Pelham Civic Center", "Birmingham", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Evansville", "IN", "USA", "United States", "Indiana", "Thunderbolts", "", "", "Ford Center", "Evansville", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Fayetteville", "NC", "USA", "United States", "North Carolina", "Marksmen", "", "", "Crown Coliseum", "Fayetteville", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Huntsville", "AL", "USA", "United States", "Alabama", "Havoc", "", "", "Von Braun Center", "Huntsville", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Knoxville", "TN", "USA", "United States", "Tennessee", "Ice Bears", "", "", "Knoxville Civic Coliseum", "Knoxville", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Macon", "GA", "USA", "United States", "Georgia", "Mayhem", "", "", "Macon Coliseum", "Macon", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Southaven", "MS", "USA", "United States", "Mississippi", "RiverKings", "", "", "Landers Center", "Mississippi", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Pensacola", "FL", "USA", "United States", "Florida", "Ice Flyers", "", "", "Pensacola Bay Center", "Pensacola", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Peoria", "IL", "USA", "United States", "Illinois", "Rivermen", "", "", "Carver Arena", "Peoria", "", True, True);
libhockeydata.MakeHockeyTeams(sqldatacon, "SPHL", 20171001, "Roanoke", "VA", "USA", "United States", "Virginia", "Rail Yard Dawgs", "", "", "Berglund Center", "Roanoke", "", True, True);
