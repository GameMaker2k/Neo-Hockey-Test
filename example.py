...
'''
    ...
    $FileInfo: example.py - Last Update: 12/03/2023 Ver. 0.8.8 RC 1 - Author: cooldude2k $
'''
        ...
        for file in files:
            ...
            if ext in extensions or subext in extensions:
                ...
                if ((ext == ".xml" or subext == ".xml") and libhockeydata.CheckXMLFile(
                        filepath) and libhockeydata.CheckHockeyXML(filepath)):
                        ...
                        for hdkey in hockeyarray[hlkey][hckey]['divisionlist']:
                            for htkey in hockeyarray[hlkey][hckey][hdkey]['teamlist']:
                                if (len(hckey) == 0 and len(hdkey) == 0):
                                    print(
                                        hockeyarray[hlkey]['leagueinfo']['fullname'] +
                                        " / " +
                                ...
                                if (len(hckey) == 0 and len(hdkey) > 0):
                                    print(
                                        hockeyarray[hlkey]['leagueinfo']['fullname'] +
                                        " / " +
                                        hockeyarray[hlkey][hckey][hdkey]['divisioninfo']['fullname'] +
                                        " / " +
                                        hockeyarray[hlkey][hckey][hdkey][htkey]['teaminfo']['fullname'])
                                if (len(hckey) > 0 and len(hdkey) == 0):
                                    print(
                                        hockeyarray[hlkey]['leagueinfo']['fullname'] +
                                        " / " +
                                        hockeyarray[hlkey][hckey]['conferenceinfo']['fullname'] +
                                        " / " +
                                        hockeyarray[hlkey][hckey][hdkey][htkey]['teaminfo']['fullname'])
                                if (len(hckey) > 0 and len(hdkey) > 0):
                                    print(
